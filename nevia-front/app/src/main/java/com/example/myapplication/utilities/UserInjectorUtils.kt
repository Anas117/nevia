...
object UserInjectorUtils {
    ...
    private var userViewModelFactory: UserViewModelFactory? = null
    ...
    private fun createFactory(context: Context): UserViewModelFactory {
        val factory = UserViewModelFactory(providerRepository(context))
    ...
    fun provideUserViewModelFactory(context: Context) =
        userViewModelFactory ?: createFactory(context)
